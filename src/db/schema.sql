...
create table if not exists business_fit_checks (
  ...
  competition_quality_score numeric,
  seller_competition_score numeric,
  exact_match_saturation_score numeric,
  duplicate_listing_score numeric,
  price_compression_score numeric,
  same_source_likelihood_score numeric,
  is_generic_commodity boolean,
  competition_gate_result text,
