...
export const latestRun: LatestRun = {
  ...
  metrics: {
    ...
    finalValidated: 10,
    finalValidatedBeforeDedupe: 11,
    duplicateAsinsRemoved: 1,
    sameBatchDuplicatesRemoved: 1,
    crossBatchRepeatsRemoved: 1,
    exportedAfterDedupe: 10,
    exportedAfterAllFilters: 9,
    repeatPolicy: 'exclude_recent',
...
export const export_batches: ExportBatch[] = [
  {
    ...
    row_count: 9,
    final_validated_before_dedupe: 11,
    duplicate_asins_removed: 1,
    same_batch_duplicates_removed: 1,
    cross_batch_repeats_removed: 1,
    final_exported_after_dedupe: 10,
    exported_after_all_filters: 9,
    repeat_policy: 'exclude_recent',
...
export const export_exclusions: ExportExclusion[] = [
  {
    id: 'mock-excl-1',
    export_batch_id: 'mock-export-batch',
    discovery_run_id: 'mock-run-id',
    otto_product_id: 'OTTO-MOCK-B0PREV1',
    asin: 'B0PREV1',
    exclusion_reason: 'PREVIOUSLY_EXPORTED_RECENTLY',
    repeat_policy: 'exclude_recent',
    lookback_days: 30,
    prior_export_batch_id: 'mock-prior-batch',
    prior_exported_at: new Date(Date.now() - 5 * 24 * 60 * 60 * 1000).toISOString(),
    created_at: NOW,
  },
];
